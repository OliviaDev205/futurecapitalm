  ...
  return (
    <>
        ...
        <div className="grid-system grid gap-x-5 grid-cols-1 md:grid-cols-2  lg:grid-cols-3 ">
          <div className="grid1 my-10">
            ...
            <section className="broker-writeup text-sm text-white/60  ">
              Future Capital Market is a financial investment company
              established by a group of professional traders and investors, who
              have fore seen the future of International Capital Market. The
              company has direct contracts with professional traders and miners
              around the world that guarantees the best services and ensures
              profits are made and remitted to investors daily.
            </section>
          </div>
          <div className="grid2 flex justify-center flex-col">
            ...
            <Link href="/auth" passHref>
              <div className="flex items-center justify-center ">
                <div className="flex w-2/3 items-center justify-center md:w-full my-5 px-6 py-4 bg-[#0066b1] rounded-lg">
                  {" "}
              ...
              <section className="email-section flex items-center ">
                ...
                <div className="emailadd text-sm">
                  ...
                  <div className="phone text-gray-400 my-1 text-sm">
                    support@futurecapital-market.com
                  </div>
                </div>
              </section>
      ...
      <div className="footer-message py-4 flex justify-center text-white/60 bg-[#0a0a0a] text-xs md:text-base">
        © 2025 futurecapital-market.com All Rights Reserved.
      </div>
    </>
  );
}
