      ...
      {details !== 0 && (
        <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-3">
          ...
          >
            ...
            >
              {details.investmentPackage === "bronze plan" || details.investmentPackage === "bronze signal" ? (
                <Image
                  alt=""
                  ...
                  height={1000}
                />
              ) : details.investmentPackage === "silver plan" || details.investmentPackage === "silver signal" ? (
                <Image
                  alt=""
                  className="w-24 h-24 opacity-10"
                  ...
                  height={1000}
                />
              ) : details.investmentPackage === "gold plan" || details.investmentPackage === "gold signal" ? (
                <Image
                  alt=""
                  className="w-24 h-24 opacity-10"
                  src="/assets/gold.png"
                  ...
                  height={1000}
                />
              ) : details.investmentPackage === "premium plan" || details.investmentPackage === "premium signal" ? (
                <Image
                  alt=""
                  className="w-24 h-24 opacity-10"
            ...
            <div className="flex items-center gap-x-3">
              ...
              <div className="text">
                <div className="currentplan_name text-sm">Latest Plan</div>
            ...
            <div className="action">
              <Link href="/dashboard/main-investment" passHref>
                <button
                  className={`py-2 z-50 text-[#0066b1] px-4 bg-[#00a05510] rounded-md text-sm font-bold ${
                    pathname.includes("main-investment") ? "hidden" : ""
                  }`}
                >
          ...
          >
            ...
            <div className="flex gap-x-3">
              ...
              <div className="text">
                <div className="currentplan_name text-sm">Total Profit</div>
                <div className="currentplan_name font-bold text-lg capitalize">
